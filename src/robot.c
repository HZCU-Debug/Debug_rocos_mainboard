...
#include "packet.h"
/*************** Globals ****************/
// Ensure the full definition of struct _robot_ is included
// #include "robot_struct.h" // Replace with the actual header file containing the definition of struct _robot_
	...
	{	   	
		...
		{ 
			...
			case NORMAL_MODE :
			{
			    ...
			    /*通讯超时设置为500ms或者?Ｊ裁炊疾蛔? 上位机8ms下发一个数据包 (共2包一包(25Byte)给一队车，另外一包给另一队车)*/
